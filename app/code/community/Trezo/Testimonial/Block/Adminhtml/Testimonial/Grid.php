...
class Trezo_Testimonial_Block_Adminhtml_Testimonial_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('avatar_name', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => new Trezo_Testimonial_Block_Adminhtml_Testimonial_Renderer_Image
            ));
