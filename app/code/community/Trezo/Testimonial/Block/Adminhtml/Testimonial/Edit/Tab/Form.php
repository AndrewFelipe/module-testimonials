...
class Trezo_Testimonial_Block_Adminhtml_Testimonial_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        if(isset($data['avatar_name']) && $data['avatar_name'] != ''){
            $avatarLink = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) .'trezo/avatar/'.$data['avatar_name'];
